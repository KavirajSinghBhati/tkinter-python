...
button_clear = Button(root, text="AC", padx=81, pady=20, command=button_clear).grid(row=4, column=1, columnspan=2)
button_equal = Button(root, text="=", padx=84, pady=20,command=button_equal).grid(row=5, column=1, columnspan=2)
